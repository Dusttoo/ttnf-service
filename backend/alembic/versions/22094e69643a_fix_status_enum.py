...
correct_status_enum = postgresql.ENUM(
    "available", "sold", "stud", "retired", "active", name="statusenum"
)
...
def downgrade() -> None:
    ...
    op.execute(
        "CREATE TYPE statusenum AS ENUM('available', 'sold', 'stud', 'retired', 'Active')"
    )
